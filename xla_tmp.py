...
parser.add_argument('--KD_alpha', type=float, default=0.9,
                    help='alpha for KD training (default: 0.9), candidate: 0.1,0.5,0.9')
...
parser.add_argument('--fake-data', action='store_true', default=False,
                    help='set to use fake imagenet data (default: "False"')
parser.add_argument('--log-steps', type=int, default=50, metavar='N',
                    help='display the loss:wq')
flags = parser.parse_args()
flags.distributed = False
flags.prefetcher = not flags.no_prefetcher
...
if __name__ == '__main__':
    xmp.spawn(_mp_fn, args=(flags,), nprocs=flags.num_gpu)
