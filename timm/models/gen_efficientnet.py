...
class InvertedResidual(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, kernel_size,
        ...
        if sampling:
            ...
            self.conv_pw = NESConv2d(in_chs, mid_chs, kernel_size=1, bias=False, multiplier = 4/2, rep_dim=0, use_coeff=False)
        else:
        ...
        if sampling:
            ...
            self.conv_pwl = NESConv2d(mid_chs, out_chs, kernel_size=1, bias=False, multiplier = 4/2, rep_dim=1, use_coeff=False)
        else:
