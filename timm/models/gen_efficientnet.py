...
from .WSConv_utils import WSConv2d, WSConv2d_v1
from .WSConv_utils import Conv2dSamePadding as sconv2d
from .bert_utils import WSConv2d_bert
...
class InvertedResidual(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, kernel_size,
                 ...
                 bn_momentum=_BN_MOMENTUM_PT_DEFAULT, bn_eps=_BN_EPS_PT_DEFAULT,
                 folded_bn=False, padding_same=False, drop_connect_rate=0.,sampling=True):
        ...
        if sampling:
            ...
            # self.conv_pw = WSConv2d_v1(in_chs, mid_chs, kernel_size=1, bias=False, multiplier = 4/2, rep_dim=0, use_coeff=False, groups=pw_group)
            self.conv_pw = WSConv2d_bert(in_chs, mid_chs, kernel_size=1, bias=False, jump = 4, rep_dim=0, use_coeff=False, mgroup = 4)
        else:
            print("Sampling based on RW code: False")
            self.conv_pw = sconv2d(in_chs, mid_chs, 1, padding=pw_padding, groups=pw_group, bias=False, multiplier = 1/1, dim=0)
        ...
        if sampling:
            ...
            self.conv_pwl = WSConv2d_v1(mid_chs, out_chs, kernel_size=1, bias=False, multiplier = 4/2, rep_dim=1, use_coeff=False, groups=pw_group)
        else:
            self.conv_pwl = sconv2d(mid_chs, out_chs, 1, padding=pw_padding, groups=pw_group, bias=False, multiplier = 1/1, dim=1)
        self.bn3 = None if folded_bn else nn.BatchNorm2d(out_chs, momentum=bn_momentum, eps=bn_eps)
...
class GenEfficientNet(nn.Module):
    ...
    def __init__(self, block_args, num_classes=1000, in_chans=3, stem_size=32, num_features=1280,
                 ...
                 folded_bn=False, padding_same=False, first_conv_stride = 2, args=None):
...
def mobilenetv2_100(pretrained=False, num_classes=1000, in_chans=3, **kwargs):
    ...
    return model
@register_model
def mobilenetv2_140(pretrained=False, num_classes=1000, in_chans=3, **kwargs):
    """ MobileNet V2 """
    default_cfg = default_cfgs['mobilenetv2_100']
    model = _gen_mobilenet_v2(0.75, num_classes=num_classes, in_chans=in_chans, **kwargs)
    model.default_cfg = default_cfg
    if pretrained:
        load_pretrained(model, default_cfg, num_classes, in_chans)
    return model
...
@register_model
def efficienti2rnet_b0(pretained=False, num_classes=1000, in_chans=3, **kwargs):
    from .efficient_i2rnet.efficient_i2rnet import EfficientNet
    return EfficientNet.from_name(model_name = 'efficientnet-b0')
@register_model
def efficientnet_b0_dq_tracing(pretained=False, num_classes=1000, in_chans=3, **kwargs):
    from .efficientnet_tracing.model import EfficientNet
    return EfficientNet.from_name(model_name = 'efficientnet-b0', margs = kwargs['args'])
@register_model
def efficientnet_b0_dq_mixnet(pretained=False, num_classes=1000, in_chans=3, **kwargs):
    from .efficientnet_mixnet.model import EfficientNet
    return EfficientNet.from_name(model_name = 'efficientnet-b0', margs = kwargs['args'])
...
@register_model
def efficientnet_b1_dq_ori(pretained=False, num_classes=1000, in_chans=3, **kwargs):
    from efficientnet_pytorch.model import EfficientNet
    return EfficientNet.from_name(model_name = 'efficientnet-b1')

@register_model
def i2rnetv3(pretained=False, num_classes=1000, in_chans=3, **kwargs):
    from .i2rnetv3 import i2rnetv3
    return i2rnetv3()
# @register_model
# def vgg_bn_dq_quant(pretained=False, num_classes=1000, in_chans=3, drop_rate=0.5, global_pool=False, bn_tf=False,bn_momentum=0.9,bn_eps=1e-4,drop_connect_rate=0.2,args=None, **kwargs):
#     from .vgg_quant import vgg16_bn_dq_quant
#     return vgg16_bn_dq_quant(**kwargs)
# 
# @register_model
# def vgg_bn_ori_quant(pretained=False, num_classes=1000, in_chans=3, drop_rate=0.5, global_pool=False, bn_tf=False,bn_momentum=0.9,bn_eps=1e-4,drop_connect_rate=0.2,args=None, **kwargs):
#     from .vgg_quant_ori import quant_vgg16_bn
#     return quant_vgg16_bn(**kwargs)

@register_model
def vgg_bn_ori_quant_v1(pretained=False, num_classes=1000, in_chans=3, drop_rate=0.5, global_pool=False, bn_tf=False,bn_momentum=0.9,bn_eps=1e-4,drop_connect_rate=0.2,args=None, **kwargs):
    from .vgg_fp import vgg16_bn_dq_quant
    return vgg16_bn_dq_quant(**kwargs)
@register_model
def efficientnet_b1_dq(pretained=False, num_classes=1000, in_chans=3, **kwargs):
    from .standard_efficientnet import EfficientNet
    return EfficientNet.from_pretrained(model_name = 'efficientnet-b1')
@register_model
def darts_searched(pretained=False, num_classes=1000, in_chans=3, **kwargs):
    from .darts_search import genotypes
    from .darts_search.model import NetworkImageNet as Network
    arch = "DARTS_DQ_i2rnet"
...
@register_model
def efficientnet_b1(pretrained=False, num_classes=1000, in_chans=3, args=None, **kwargs):
    """ EfficientNet-B1 """
